...
$('#thetower').click(function(){
  ...
  $('.pthetower').fadeIn("1000ms");
  $('.lighthouse').fadeOut("500ms");
  $('.parchitecture').fadeOut("500ms");
  $('.pthiscity').fadeOut("500ms");
  $('.pabout').fadeOut("500ms");
  $('.pconstruction').fadeOut("500ms");
...
$('#architecture').click(function(){
  ...
  $('.parchitecture').fadeIn("1000ms");
  $('.lighthouse').fadeOut("500ms");
  $('.pabout').fadeOut("500ms");
  $('.pthiscity').fadeOut("500ms");
  $('.pthetower').fadeOut("500ms");
  $('.pconstruction').fadeOut("500ms");
...
$('#construction').click(function(){
  ...
  $('.pconstruction').fadeIn("1000ms");
  $('.pabout').fadeOut("500ms");
  $('.parchitecture').fadeOut("500ms");
  $('.pthiscity').fadeOut("500ms");
  $('.pthetower').fadeOut("500ms");
  $('.plighthouse').fadeOut("500ms");
